...
class Client(Base):
    ...
    # Relationships – required for eager loading and .has() queries
    creator = relationship("User", foreign_keys=[created_by], lazy="select")
    travel_type = relationship("TravelType", foreign_keys=[travel_type_id], lazy="select")
    ...
    __table_args__ = (
        ...
        Index(
            "idx_clients_names_trgm",
            "surname", "given_name", "father_name",
